...
import com.stellarix.hse.service.HabilitationService;

import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/hse/habilitations")
...
public class HabilitationController {
    ...
    public ResponseEntity<Habilitation> create(@Valid @RequestBody HabilitationRequest request) {
