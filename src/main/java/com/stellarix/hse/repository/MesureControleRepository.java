...
public interface MesureControleRepository extends JpaRepository<MesureControle, UUID>{
...
//	@Query(value = "SELECT * FROM hse_schema.mesure_controle where toko5_id = :toko5Id", 
//		    nativeQuery = true)
//			List<MesureControle> findByToko5Id(@Param("toko5Id") UUID toko5Id, @Param("questionId") );
//
